...
public class ProductResourceLibActivity extends BaseActivity {
	...
	private void initData() {
		...
		mClass_List= (ProductCategory) intent.getSerializableExtra(Define.DATA);
	}
	...
	private void initView() {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterView, View view, int position, long arg3) {
				...
				Intent intent = new Intent(ProductResourceLibActivity.this,ProductInfoActivity_.class);
				intent.putExtra(Define.DATA, (Serializable) resource);
...
//				lastClickPosition = position;
		...
		// 下拉刷新配置
		MaterialHeader materialHeader = new MaterialHeader(ProductResourceLibActivity.this);
		...
		public void handleMessage(Message msg) {
			...
			case NORE_MORE_DATA: // 没有更多数据
				if (isNeedToShowNoMoreTips) {
					...
					Toast.makeText(ProductResourceLibActivity.this, noreMoreDataTips, Toast.LENGTH_SHORT).show();
				}
				break;
	...
	private void loadProductList() {
		...
		ProductManager.getInstance().loadProductResource(currentPageNum, sort, cityId, productType, minPrice, maxPrice, new ProductResourceListCallback() {
	...
	private void initAdvanceRankingPopupLayout() {
		...
		destinationTextView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(ProductResourceLibActivity.this, AreaListActivity_.class);
				intent.putExtra(Define.FROM, ProductResourceLibActivity.class.getSimpleName());
		...
		confirmTextView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (minPrice > maxPrice) {
					...
					advanceRankingPopupLayout.setVisibility(View.GONE);
					InputMethodUtils.closeInputKeyboard(ProductResourceLibActivity.this); 
					advancedRankingTextView.setTextColor(getResources().getColor(R.color.v909090)); 
					advancedRankingTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.arrow_black_triangle_down, 0);
					handler.sendEmptyMessageDelayed(REFRESH_DATA, 100);
				}
	...
	class ProductResourceAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				convertView = LayoutInflater.from(ProductResourceLibActivity.this).inflate(R.layout.item_product_resource, null);
				...
				viewHolder.storeNameTextView = (TextView) convertView.findViewById(R.id.tv_store_name);
			...
			// 来源店铺
			String storeName = resource.getName();
			...
			if (isAdded) {
				viewHolder.addedCoverImageView.setVisibility(View.VISIBLE);
			} else {
				viewHolder.addedCoverImageView.setVisibility(View.INVISIBLE);
			}
