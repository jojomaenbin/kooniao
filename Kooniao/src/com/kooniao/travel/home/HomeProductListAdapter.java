...
public class HomeProductListAdapter extends BaseAdapter implements StickyListHeadersAdapter {
	...
	public View getHeaderView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(R.layout.home_page_product_stick_top, null);
